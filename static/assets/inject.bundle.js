...
console.log("init'd new page", window.location.href);

var polyeth = require( '../lib/poly-eth');
var eth = polyeth( window.window );


// var ethos = require('../lib/ethos');
// document.write('<img src="http://localhost:1337/nav?url=etst" alt="" />');
...
},{"../lib/poly-eth":2}],2:[function(require,module,exports){

//var bigInt = require( './lib/BigInteger' );
//var EthString = require( './lib/ethstring' );

var polyeth = function(window) {

  var eth = window.eth;
  var cppEth = require( './lib/eth')(window);
...
},{"./lib/eth":4}],3:[function(require,module,exports){
var bigInt = (function () {
...
var EthString = require( './ethstring');
...
module.exports = function(window) {
    ...
    window.String.prototype = EthString.prototype;
        ...
        window.eth = (function ethScope() {
                ...
                function reqAsync(m, p, f) {
                    ...
                    request.onreadystatechange = function() {
                        try {
                            if (request.readyState === 4) f(reformat(m, JSON.parse(request.responseText).result))
                        } catch (e) {
                            console.log(e);
                        }
                    };
